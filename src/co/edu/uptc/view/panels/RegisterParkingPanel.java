...
public class RegisterParkingPanel extends JPanel {
    ...
    public RegisterParkingPanel() {
        ...
        schedulePanel.add(new JLabel("Lunes a Viernes"));
        schedulePanel.add(new JLabel(""));
        schedulePanel.add(new JLabel("Fin de semana"));
        schedulePanel.add(new JLabel(""));

        schedulePanel.add(new JLabel("Apertura:"));
        schedulePanel.add(weekdayOpenField);
        schedulePanel.add(new JLabel("Apertura:"));
        schedulePanel.add(weekendOpenField);

        schedulePanel.add(new JLabel("Cierre:"));
